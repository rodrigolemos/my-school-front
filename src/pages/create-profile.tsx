    ...
    try {
      ...
      if (error.response) {
        if (error.response.status == 400 || error.response.status == 401) {
          setError('Ops, não foi possível criar o seu perfil. Por favor, confira suas informações e tente novamente.')
        } else {
          setError('Ops, não foi possível criar o seu perfil. Por favor, tente novamente mais tarde.')
        }
      } else {
