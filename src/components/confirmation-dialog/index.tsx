    ...
    <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title" fullWidth={true} maxWidth="sm">
      <CustomDialogContent customtheme={theme}>
        ...
        <Form>
          ...
          <div className="alert">
            Atenção! Deseja realmente excluir o usuário <u>{userToDelete.name}</u>? Essa ação não pode ser desfeita.
          </div>
          {!loading ? (
            <DialogActions>
              <Button onClick={deleteUser} variant="contained" color="secondary" size="large">Excluir</Button>
